...
/**
 * Шаги живут в `lib/millwork/steps.ts`.
 *
 * Полоса их только рисует: список, названия и то, что лежит на каждом
 * шаге, — одна таблица на продукт, и вторая её копия в разметке
 * разошлась бы с первой на первом же новом шаге.
 */
export type { StepKey } from '@/lib/millwork/steps';
import type { StepKey } from '@/lib/millwork/steps';
