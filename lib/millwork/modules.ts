...
export const GEOMETRY = {
  ...
  upper: {
    ...
    /**
     * Ниже этого верхний шкаф делать незачем: полка в него не встаёт, а
     * корпус, фасад и петли стоят как у нормального. Под ригелем, который
     * оставил меньше, ряд разрывается — как на окне.
     */
    minCarcassH: 300,
  },
  tall: {
