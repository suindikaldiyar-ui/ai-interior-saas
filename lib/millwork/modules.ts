...
export const APPLIANCE_COLUMN = {
  ...
  shelfMm: 16,
  /**
   * ВЫШЕ ЭТОГО ПРИБОР НЕ СТАВЯТ.
   *
   * Верх верхней ниши — не выше 1500 мм от пола. Из духовки выше пояса
   * горячий противень не вынуть: это не вкус, а ожог. Правило жёлтое, не
   * запрещающее — замерщик главнее алгоритма, но знать обязан.
   */
  maxReachMm: 1500,
} as const;
