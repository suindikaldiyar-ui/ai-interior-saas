    ...
    return (
      <main className="mw-root flex min-h-screen items-center justify-center p-6">
        <div className="max-w-md text-center">
          <h1 className="mb-2 text-[18px] font-semibold">Кабинет недоступен</h1>
          <p className="mb-4 text-[13px] text-graphiteMw">
            Supabase не настроен. Демонстрация открывается без входа.
          </p>
  ...
  return (
    <main className="mw-root min-h-screen">
      <header className="flex flex-wrap items-center gap-x-4 gap-y-2 border-b border-navyLine px-4 py-3">
        ...
        <span className="mw-num text-[12px] text-graphiteMw">{projects.length}</span>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link
            href="/measure"
            className="mw-touch flex items-center border border-cyanBright bg-cyanBright px-3 text-[11px] uppercase tracking-[0.1em] text-navyDeep"
          >
            Новый объект
          </Link>
        </div>
